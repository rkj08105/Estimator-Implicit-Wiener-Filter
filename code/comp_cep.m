% Program to find cepstrum distance. ok. 
...
% t=0.025; % frame duration=25 milli sec (as per our program)
% winlength   = round(30*sample_rate/1000); % window length in samples
% (original)
winlength   = round(25*sample_rate/1000); %240 % window length as per our program
